...
from src.threat.clustering.ConstrainedPoisoningGlobal import (
    ConstrainedAdvPoisoningGlobal,
)
        ...
        for seed in seeds:
            for dt in tqdm(dt_range, total=len(dt_range)):
                for s in s_range:
                    ...
                    print("attaccati {} samples".format(n_points))
                    writer.write(
                        "{};{};{};{};{};{};{};{};{};{};{};{};{};{};{};{};{}".format(
                            seed,
                            model.to_string(),
...
def train(Xtrain, Ytrain):
    rand_frst_10 = RandomForestPartition.from_train((Xtrain.cpu(), Ytrain.cpu()), n_estimators=10)
    print("rand10")
    rand_frst_100 = RandomForestPartition.from_train((Xtrain.cpu(), Ytrain.cpu()), n_estimators=100)
    print("rand100")
    # rand_frst_1000 = RandomForestPartition.from_train((Xtrain, Ytrain), n_estimators=1000)
