...
op = OptionParser()
op.add_option("--show_fig", default=False,
              help="Show visual quality assessment.")
(opts, args) = op.parse_args(sys.argv[1:])

X = np.load("comparison/MNIST/wip_MNIST_X_org_23.npy")
Xadv_s = np.load("comparison/MNIST/wip_MNIST_X_adv_23.npy")
...
show_fig(X, Xadv_s, Xadv_m, idx_m, idx_s, shape=(28, 28), out_file="mnist_32.png")
