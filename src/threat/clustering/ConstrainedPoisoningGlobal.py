import math, torch
from src.AdversarialBase import AdversarialBase
from src.optimizer.GenEvolve import SingleGenOptimization
from heapq import *
...
class ConstrainedAdvPoisoningGlobal(SingleGenOptimization, AdversarialBase):
    ...
    def global_evolve_perturbation(self, X, ts_idx):
        ...
        # print(
        #    "DIST FROM INITIAL: ", (opt_eps- eps0).norm(2)
        # )
        return opt_eps  # self.get_best_candidate(candidates)
